...
/*   Updated: 2021/06/19 20:12:55 by acami            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int32_t extra_param)
{
	...
	t = (double)iterations / max_iterations;
	colour = 0;
	colour |= (((int8_t)((extra_param % 27) * (1 - t)
					* pow(t, 3) * 255)) << 16) & 0xff0000;
	colour |= ((int8_t)((extra_param % 45) * pow((1 - t), 2)
				* pow(t, 2) * 255) << 8) & 0xff00;
	colour |= (int8_t)((extra_param % 12) * pow((1 - t), 3) * t * 255) & 0xff;
	return (colour);
}
...
int32_t extra_param)
{
	...
	colour = 0;
	colour |= ((int8_t)(15 * pow((1 - t), 2) * pow(t, 2) * 255) << 16)
		& 0xff0000;
